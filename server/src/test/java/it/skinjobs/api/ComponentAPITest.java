...
public class ComponentAPITest {
   ...
   public void insertOne() throws Exception {
      ...
      Mockito.when(components.save(Mockito.any())).thenReturn(this.saved);
   ...
   public void deleteEntityTest2() {
      Mockito.when(components.findById(anyInt())).thenReturn(Optional.empty());
      assertFalse(this.componentAPI.deleteEntity(0));
   }
