...
public class ComponentFamilyAPI extends BaseAPI<ComponentFamily, ComponentFamilyDTO, Integer> {
   ...
   private final CompatibilityConstraintsAPI compatibilityConstraintsAPI;
    ...
    * @param componentTypes              the component types repository
    * @param compatibilityConstraintsAPI the compatibility constraints API for
    *                                    cascade operations
    * @param componentAPI                the component API for cascade operations
    */
   public ComponentFamilyAPI(CredentialAPI credentialAPI,
      ...
      this.compatibilityConstraintsAPI = compatibilityConstraintsAPI;
